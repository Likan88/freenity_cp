        ...
        <div class="select_block right">
            ...
            <div class="other_row">
                ...
                <div sid="2" class="one_status">
                  <span class="id" data-name="id" style="display:none">admin</span>
                  <span class="name" data-name="name_ru">Admin</span>
                </div>
                <div sid="2" class="one_status">
                  <span class="id" data-name="id" style="display:none">sudo</span>
                  <span class="name" data-name="name_ru">Super Admin</span>
                </div>
            </div>
        </div>
              ...
              <div class="select_block ">
                  ...
                  <div class="other_row">
                      ...
                      <div sid="2" class="one_status set_role">
                        <span class="id" style="display:none">admin</span>
                        <span class="name" >admin</span>
                      </div>
                      <div sid="2" class="one_status set_role">
                        <span class="id" style="display:none">sudo</span>
